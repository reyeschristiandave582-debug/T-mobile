    ...
    <footer className="relative z-10 w-full max-w-[512px] mx-auto px-4 pt-0 pb-12 mt-6 text-center">
      ...
      <div className="flex items-center justify-center gap-1.5 mb-2">
          <a 
            ...
            className="w-7 h-7 rounded-full bg-[#333333] hover:bg-[#333333] flex items-center justify-center text-white hover:scale-110 transition-transform duration-300"
            aria-label="Facebook"
          >
